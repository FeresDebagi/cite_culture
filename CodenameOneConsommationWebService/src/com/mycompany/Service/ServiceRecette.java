...
public class ServiceRecette {
    ...
    public void ajoutRecette(Formation r) {
        ConnectionRequest con = new ConnectionRequest();
        String Url = "http://localhost/CiteDeLaCulture/web/app_dev.php/new?" + "&formateurformation=" + r.getFormateurformation() + "&classeformation=" + r.getClasseformation() + "&typeformation="+ r.getTypeformation() +"&prixformation="+r.getPrixformatiion() ;
        con.setUrl(Url);
     ...
     public void updateRecette(Formation r) {
        ...
        String Url = "http://localhost/CiteDeLaCulture/web/app_dev.php/recettes/update?" + "nom=" + r.getFormateurformation() + "&description=" + r.getClasseformation()
