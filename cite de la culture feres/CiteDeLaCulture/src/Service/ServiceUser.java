...
public class ServiceUser {
    ...
    /*public void ajouterPersonne(User p) throws SQLException{
      String requete = "INSERT INTO `user` (`id_user`, `login_user`, `mdp_user`,`mail_user`) "
              + "VALUES (NULL, '"+p.getLogin_user()+"', '"+p.getMdp_user()+"', '"+p.getMail_user()+"');";
    ste.executeUpdate(requete);
        System.out.println("elment done");
    }*/
