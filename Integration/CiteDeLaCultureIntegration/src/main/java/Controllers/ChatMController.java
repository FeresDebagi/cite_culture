 ...
 * @author Elyes
 */
public class ChatMController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            Logger.getLogger(ChatMController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void GoToWindow(ActionEvent event) throws IOException, SQLException {
        ...
        WindowMController asc = loader.getController();
