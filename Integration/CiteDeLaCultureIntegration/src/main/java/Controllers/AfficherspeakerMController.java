...
import Controllers.AjouterspeakerMController;
import Controllers.SpeakerDetailedMController;
 ...
 * @author Elyes
 */
public class AfficherspeakerMController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try{
            ...
            Logger.getLogger(AfficherspeakerMController.class.getName()).log(Level.SEVERE, null, ex);
        }
        // TODO
        // TODO
    }    
    ...
    private void detailed(MouseEvent event) throws IOException, SQLException {
        ...
        FXMLLoader loader = new FXMLLoader();
        loader.setLocation(getClass().getResource("/Views/SpeakerDetailedM.fxml"));
        Parent root = loader.load();
        tftableSpeaker.getScene().setRoot(root);

        SpeakerDetailedMController sdc = loader.getController();
