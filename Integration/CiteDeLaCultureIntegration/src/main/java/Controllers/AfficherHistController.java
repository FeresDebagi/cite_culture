 ...
 * @author Elyes
 */
public class AfficherHistController implements Initializable {
    ...
    private void detail(MouseEvent event) throws IOException, SQLException {
        ...
        loader.setLocation(getClass().getResource("/Views/HistDetailed.fxml"));
        Parent root = loader.load();
        tftableHist.getScene().setRoot(root);

        HistDetailedController_1 fdc = loader.getController();
        ...
        HistDetailedController_1 wc = loader.getController();
    ...
    private void GoToAdd(ActionEvent event) throws IOException, SQLException {
        FXMLLoader loader = new FXMLLoader();
        loader.setLocation(getClass().getResource("/Views/AjouterHist.fxml"));
        Parent root = loader.load();
        tftableHist.getScene().setRoot(root);
        
        
        ServiceUser SU = new ServiceUser();
        AjoutHistController wc = loader.getController();
        wc.login(tflogin.getText());
