 ...
 * @author Elyes
 */
public class SpeakerDetailedController implements Initializable {
    ...
    private void Gotoedit(ActionEvent event) throws IOException, SQLException {
        ...
        loader.setLocation(getClass().getResource("/Views/modifierspeaker.fxml"));
        Parent root = loader.load();
        tfedit.getScene().setRoot(root);

        ModifierspeakerController mdc = loader.getController();
    ...
    private void Gotodelete(ActionEvent event) {
        ...
        if (result.get() == ButtonType.OK) {
            ...
            try {
                ...
                Logger.getLogger(SpeakerDetailedController.class.getName()).log(Level.SEVERE, null, ex);
            }
        } else {
