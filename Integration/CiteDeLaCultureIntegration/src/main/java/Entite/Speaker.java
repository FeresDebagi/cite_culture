...
public class Speaker {
    private int id_speaker,idU_fk ;
  private String nom_speaker,prenom_speaker,mail_speaker,date_arrive,date_depart,description_speaker,PhotoSpeaker,proprietaire_speaker;

    public Speaker(int id_speaker, int idU_fk,String nom_speaker, String prenom_speaker, String mail_speaker, String date_arrive, String date_depart, String description_speaker,String PhotoSpeaker,String  proprietaire_speaker) {
        ...
        this.PhotoSpeaker=PhotoSpeaker;
         this.proprietaire_speaker = proprietaire_speaker;
    }

    public String getProprietaire_speaker() {
        return proprietaire_speaker;
    }

    public void setProprietaire_speaker(String proprietaire_speaker) {
        this.proprietaire_speaker = proprietaire_speaker;
    }
    ...
    public String toString() {
        return "Speaker{" + "id_speaker=" + id_speaker +", idU_fk=" + idU_fk + 
                ", nom_speaker=" + nom_speaker + ", prenom_speaker=" + prenom_speaker 
                + ", mail_speaker=" + mail_speaker + ", date_arrive=" + date_arrive 
                + ", date_depart=" + date_depart + ", description_speaker="
                + description_speaker + ", PhotoSpeaker"+PhotoSpeaker+",proprietaire_speaker"+proprietaire_speaker+'}';
    }
