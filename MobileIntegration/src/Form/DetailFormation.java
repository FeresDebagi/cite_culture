...
import DAO.InscriptionFormationDAO;
            ...
            if (Dialog.show("Confirmer", "Voulez-vous supprimer cette formation?", "Ok", "Cancel")) {
                ...
                t.getT().show();
                    ...
                    btninscri.addActionListener(new ActionListener() {
                     ...
                     InscriptionFormation e = new InscriptionFormation((id), authentification.iduser);

                            InscriptionFormationDAO inscriptionEventDAO = new InscriptionFormationDAO();
